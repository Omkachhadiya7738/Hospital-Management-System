        ...
        <div class="container" style="margin-top:07%;margin-left:230px;">
            <div class="row justify-content-lg-center">
                <div class="col-6">
                    ...
                    <form class="row" action="patiant connect.php" method="POST" name="forms" onsubmit="return om()">
                        ...
                        <div class="col-lg-8 col-sm-12">   
                            <a href="patiant.php"><input type="submit" value="Send" class="btn btn-primary" style="margin-top:20px;"/></a>
