...
<div id="main">
  ...
  <div>
  <br>
  <h1 style="margin-left:30px;">Admit</h1>
  <button type="button" class="btn btn-outline-primary" style="margin-left:830px;"><a href="patiant admit form.php" id="add">Add Admit History</a></button>
    <?php
      include("conn.php");
...
?>
  ...
  <table cellpadding="7px">
        ...
        <tr>
            ...
            <td><a href="patiant edit btn.php?id=<?php echo $row["ID"];?>" class="btn btn-success">Edit</a> 
            <a href="patiant delete.php?id=<?php echo $row["ID"];?>" class="btn btn-danger">Delete</a></td>
        </tr>
        <?php
      }
    }
...
function openNav() {
  ...
  document.getElementById("marq").style.width = "130px";
}
