...
<div id="main">
  ...
  <div>
  <br>
  <h1 style="margin-left:30px;">Medicine</h1>
  <button type="button" class="btn btn-outline-primary" style="margin-left:813px;"><a href="patiant medicine form.php" id="add">Add Medicine History</a></button>
    <?php
      include("conn.php");
...
?>
  ...
  <table cellpadding="7px">
        ...
        <tr>
            ...
            <td><a href="medicine edit btn.php?id=<?php echo $row["ID"];?>" class="btn btn-success">Edit</a> 
            <a href="medicine delete.php?id=<?php echo $row["ID"];?>" class="btn btn-danger">Delete</a></td>
        </tr>
        <?php
      }
    }
?>
 ...
 <footer class="main-footer" style="bottom:0;width:1400px;position:fixed;">
...
function openNav() {
  ...
  document.getElementById("marq").style.width = "30px";
}
