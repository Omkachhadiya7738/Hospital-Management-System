...
<div id="main">
  ...
  <br><br>
  <h1 style="margin-left:25px;">Doctor Details</h1>
  <button type="button" class="btn btn-outline-primary" style="margin-left:980px;"><a href="doctor add.php" id="add">Add Doctor</a></button>
  <?php
      include("conn.php");
...
?>
  ...
  <footer class="main-footer" style="bottom:10;width:1300px;position:fixed;margin-top:210px;">
