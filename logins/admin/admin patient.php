...
<div id="main">
  ...
  <br><br>
  <h1 style="margin-left:25px;">Patiant Details</h1>
  <button type="button" class="btn btn-outline-primary" style="margin-left:950px;"><a href="patiant add.php" id="add">Add Patiant</a></button>
  <?php
      include("conn.php");
