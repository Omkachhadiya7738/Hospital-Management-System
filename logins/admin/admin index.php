 <?php
      ...
      $sql = "SELECT * FROM patiant_contact";
      ...
      $doctorCount = mysqli_num_rows($result1);
...
<div id="main">
  ...
  <br><br>
  <h1>Dashboard</h1>
  <div style="display: flex;justify-content: flex-center;margin-left:30px;">
   
    <div class="flip-card">
      <div class="flip-card-inner">
        <div class="flip-card-front">
          <img src="image/patient.jpg" alt="Avatar" style="width:200px;height:200px;">
        </div>
        <div class="flip-card-back">
          <h1>Patient</h1>
          <br>
          <a href="admin patient.php" style="color:white;"><h5>No. Of Patient :- <?php echo $patientCount;?> </h5></a> 
        </div>
      </div>
    </div>
    ...
    <div class="flip-card">
      <div class="flip-card-inner">
        <div class="flip-card-front">
          <img src="image/doctor.jpg" alt="Avatar" style="width:200px;height:200px;">
        </div>
        <div class="flip-card-back">
          <h1>Doctor</h1>
          <br>
          <a href="admin doctor.php" style="color:white;"><h5>No. Of Doctor :- <?php echo $doctorCount;?> </h5></a> 
