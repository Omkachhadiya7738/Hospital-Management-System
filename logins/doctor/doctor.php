...
<div id="mySidenav" class="sidenav">
  ...
  <br>
 <span><a href="appoinmentshow.php">Appointment</a></span>
</div>
...
<div id="main">
  ...
  <div>
    ...
    <?php if (!empty($doctorName)): ?>
        <h2 style="text-align:center; margin-top:20px;"><?php echo htmlspecialchars($doctorName); ?></h2>
    <?php endif; ?>
  <br><br>
    <div class="flip-card">
      <div class="flip-card-inner">
        <div class="flip-card-front">
          <img src="image/appointment.jpg" alt="Avatar" style="width:200px;height:200px;">
        </div>
        <div class="flip-card-back">
          <h1>Patient</h1>
          <br>
          <a href="appoinmentshow.php" style="color:white;"><h3>Appointment <br> <?php echo $appointmentCount; ?></h3></a>
        </div>
      </div>
      <h2>Appointments</h2>
    </div>
