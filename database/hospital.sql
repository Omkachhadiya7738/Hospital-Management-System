...
INSERT INTO `doctor` (`id`, `name`, `address`, `number`, `work`) VALUES
(1, 'Dr Vivek', 'aadarsh dream-1 rajkot gujarat-360004', 7658763876, 'General Physician'),
(2, 'Dr Vivek', 'aadarsh dream-1 rajkot gujarat-360004', 9078564567, 'Dental'),
(3, 'Dr Het Patel', 'aadrsh dream - 1rajkot gujarat', 8990786756, 'Ortho'),
(4, 'Dr Dhruva ', 'aadarsh dream-1 rajkot gujarat-360004', 9087564567, 'Nuero Surgen'),
(5, 'Dr Hit Patel', 'aadrsh dream - 1rajkot gujarat', 8990786756, 'Ortho');
...
(30, 'Omkumar R Kachhadiya', 9724293488, '2025-08-09', 'Gujarat', '360004', 'dr vivek', '4:30 PM', 'omrajkachhadiya@gmail.com');
